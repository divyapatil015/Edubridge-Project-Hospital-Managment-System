...
//			throw new ResourceNotFoundException("Admin","present",admin.adminEmailId);
	...
	public Admin loginAdmin(Admin admin) {
		...
		return this.adminRepository.findByAdminEmailIdAndAdminPassword(admin.adminEmailId, admin.adminPassword).orElseThrow(()->new ResourceNotFoundException("Admin ", "EmaildId" +admin.adminEmailId+" and password "+admin.adminPassword, admin));
	}
